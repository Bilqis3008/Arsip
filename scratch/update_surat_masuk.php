...
$content = str_replace($fetch_old, $fetch_new, $content);

// 2. Update Tabs
$tabs_old = '<button class="tab-btn" onclick="switchTab(\'riwayat\')">';
$tabs_new = '<button class="tab-btn" onclick="switchTab(\'tugas\')">
...
$section_new = '            <!-- Section: Surat Tugas -->
...
echo "Successfully updated surat_masuk.php";
?>
