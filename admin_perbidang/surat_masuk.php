                                    ...
                                    <td style="text-align: center;">
                                        <div style="display: flex; gap: 0.5rem; justify-content: center;">
                                            ...
                                            <?php if ($tab === 'unread'): ?>
                                                ...
                                                <button onclick="openArchiveModal(<?= $m['id_surat_masuk'] ?>, '<?= htmlspecialchars(addslashes($m['perihal'])) ?>')" class="btn-action" style="background: var(--navy); color: var(--primary); border: none; cursor: pointer;" title="Arsip Langsung"><svg class="icon" viewBox="0 0 24 24"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg> </button>
                                            <?php else: ?>
                                                <a href="monitoring_tindakLanjut.php?id=<?= $m['id_surat_masuk'] ?>" class="btn-action" style="background: #f1f5f9; color: var(--navy); border: 1px solid var(--border);"><svg class="icon" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="m12 8 0 4 2 2"/></svg> Track</a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                </tr>
