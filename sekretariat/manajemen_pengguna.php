...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="manajemen_pengguna.php" class="menu-item active"><svg class="icon" viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Manajemen Pengguna</a>
    ...
    <main class="main-content">
        ...
        <div class="content-body">
            ...
            <div class="module-tabs">
                ...
                <button class="tab-btn" onclick="switchTab('tambah')"><svg class="icon" viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M19 8v6m3-3h-6"/></svg> Tambah Baru</button>
            </div>
                    ...
                    <div class="role-group">
                        <div class="role-header">
                            <div class="role-title-wrapper">
                                <div class="role-icon"><svg class="icon" viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div>
                                    ...
                                    <?php foreach ($roleUsers as $u): ?>
                                        <tr>
                                            ...
                                            <td class="action-btns">
                                                <button onclick='viewDetail(<?= htmlspecialchars(json_encode($u)) ?>)' class="action-btn btn-view" title="Detail"><svg class="icon" viewBox="0 0 24 24"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg></button>
                                                <button onclick='openEditModal(<?= htmlspecialchars(json_encode($u)) ?>)' class="action-btn btn-edit" title="Edit"><svg class="icon" viewBox="0 0 24 24"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg></button>
                                                <button onclick="confirmDelete('<?= $u['nip'] ?>')" class="action-btn btn-delete" title="Hapus"><svg class="icon" viewBox="0 0 24 24"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
